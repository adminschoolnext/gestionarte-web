...
-- ============================================================
-- Migration: 003_add_survey_question_logic.sql
-- Version: 4
...
-- ==========================================
-- CREACIÓN DE TABLA: survey_question_logic
-- ==========================================

CREATE TABLE IF NOT EXISTS public.survey_question_logic (
    logic_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    question_id UUID NOT NULL,
    condition_type VARCHAR(50) NOT NULL CHECK (condition_type IN ('equals', 'not_equals', 'contains', 'greater_than', 'less_than')),
    ...
    CONSTRAINT survey_question_logic_target_section_fkey 
        ...
        REFERENCES public.survey_sections(section_id) 
        ON DELETE CASCADE,
    ...
    -- Constraint: Solo una regla activa por pregunta
    CONSTRAINT survey_question_logic_unique_active 
        UNIQUE (question_id, is_active)
);
